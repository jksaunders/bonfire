  ...
  return (
    <ThemeProvider theme={theme}>
      <div>
        ...
        <div>
          <Typography variant={MaterialVariants.Subtitle1}>
            subtitle1
          </Typography>
        </div>
        <div>
          <Typography variant={MaterialVariants.Subtitle2}>
            subtitle2
          </Typography>
        </div>
        <div>
...
export const SampleText = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <div>
        <div>
          <Typography variant={MaterialVariants.H1}>
            Welcome to bonfire
          </Typography>
          ...
          <Typography variant={MaterialVariants.Body1}>
            ...
            and adjusting the space between pairs of letters (kerning). The term
            typography is also applied to the style, arrangement, and appearance
            of the letters, numbers, and symbols created by the process. Type
            design is a closely related craft, sometimes considered part of
            typography; most typographers do not design typefaces, and some type
            designers do not consider themselves typographers. Typography also
            may be used as a decorative device, unrelated to communication of
            information.
          </Typography>
          <Typography variant={MaterialVariants.Body1}>
            ...
            capability to create typography has become ubiquitous, the
            application of principles and best practices developed over
            generations of skilled workers and professionals has diminished. So
            at a time when scientific techniques can support the proven
            traditions (e.g., greater legibility with the use of serifs, upper
            and lower case, contrast, etc.) through understanding the
            limitations of human vision, typography as often encountered may
